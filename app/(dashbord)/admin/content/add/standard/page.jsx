  ...
  return (
    <div className="w-full max-w-2xl mx-auto bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden mb-8 mt-6">
      ...
      <div className="px-6 py-5 border-b border-gray-100 flex items-center bg-white gap-4">
        ...
        <h6 className="text-gray-900 text-lg font-bold">Add Engineering Standard</h6>
      </div>
      ...
      <div className="p-6 sm:p-8 bg-gray-50/30">
        <form onSubmit={handleSubmit} autoComplete="off" className="space-y-5">
          <div>
            ...
            <input type="text" name="title" required value={formData.title} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition-all duration-200 outline-none text-gray-700" placeholder="e.g. Modern Tech Stack" />
          </div>
          <div>
            <label className="block text-gray-700 text-sm font-semibold mb-2">Description</label>
            <textarea name="desc" required value={formData.desc} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition-all duration-200 outline-none text-gray-700" placeholder="Detail about this standard..." rows={3} />
          </div>
